...
#+BEGIN_SRC elisp :results none :tangle .emacs
    (load "~/literate_emacs_update/package-new.el")
    (load "~/literate_emacs_update/keybindings.el")
    (load "~/literate_emacs_update/cpp.el")
    (load "~/literate_emacs_update/setup-editing.el")
    (load "~/literate_emacs_update/ess.el")
    (load "~/literate_emacs_update/latex-ess.el")
    (load "~/literate_emacs_update/org-setup.el")
(load "~/literate_emacs_update/python.el")
(load "~/literate_emacs_update/tramp.el")
